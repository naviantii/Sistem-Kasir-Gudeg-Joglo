...
<!--Header-part-->
<div id="header">
  <img id="logo" style="width :200px" src="gambar/logo2.png">
</div>
<!--close-Header-part--> 
        ...
        <div class="widget-box span12">
          ...
          <div class="widget-content">
            <div class="alert alert-info alert-block">
              <h4 class="alert-heading">Pemesanan telah dilakukan !</h4>
              Kelola transaksi pada menu Entri Transaksi<br>
            </div>
          </div>
        </div>
      </div>
      ...
      <?php
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            while($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)){
              ...
              $tempe = intval($_POST['jumlah'.$tahu]);
              ...
              $sisa_stok = intval($result_stok['stok']) - $tempe;
              //echo $tempe;
              ...
              $query_kelola_stok = "update tb_stok set jumlah_terjual = $tempe where id_stok = (SELECT id_stok FROM tb_pesan WHERE id_pesan = $id_pesan)";
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Gudeg Joglo </div>
</div>
